	...
	public class MergingFiles {
		...
		public static void main(String[] args) {
			...
			String fileOne, fileTwo, fileThree, line, content="";
			 ...
			 try
		      {
		         FileReader frOne = new FileReader(" C:\\Users\\sudhe\\eclipse-workspace\\CoreJava\\src\\abstractt");
		         BufferedReader brOne = new BufferedReader(frOne);
		         FileReader frTwo = new FileReader(" C:\\Users\\sudhe\\eclipse-workspace\\CoreJava\\src\\array");
		         ...
		         try
		         {
		            FileWriter fw = new FileWriter(" C:\\Users\\sudhe\\eclipse-workspace\\CoreJava\\src\\comparatorandcomparable", true);
		            fw.write(content);
		            fw.close();
